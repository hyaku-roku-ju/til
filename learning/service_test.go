...
func (self *LearningRepositoryStub) CountConfirmedLearnings(ctx context.Context, reporterId string) (int, error) {
	return 99, nil
}

func (self *LearningRepositoryStub) GetConfirmedLearning(ctx context.Context, reporterId string, n int) (Learning, error) {
	return Learning{}, nil
}
